...
String myform() {
  ...
  " .heading:hover{border-left: 7px dotted black; border-bottom: 7px dashed black; font-family:Times New Roman; letter-spacing: 20px; color: white;  animation: animate 8s linear infinite; }"
